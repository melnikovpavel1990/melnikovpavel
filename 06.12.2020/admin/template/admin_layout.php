...
<div class="hk-wrapper hk-vertical-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <ul id="forms_drp" class="nav flex-column collapse collapse-level-1">
                            <li class="nav-item">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/admin/?action=list_page">Статьи</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/admin/?action=category_page">Товары</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <div class="hk-settings-panel">
        <div class="nicescroll-bar position-relative">
            <div class="settings-panel-wrap">
                <div class="settings-panel-head">
                    <img class="brand-img d-inline-block align-top" src="../../admin_assets/dist/img/logo-light.png" alt="brand" />
        ...
        <img class="d-none" src="../../admin_assets/dist/img/logo-light.png" alt="brand" />
        <img class="d-none" src="../../admin_assets/dist/img/logo-dark.png" alt="brand" />
    </div>
    <!-- /Setting Panel -->
