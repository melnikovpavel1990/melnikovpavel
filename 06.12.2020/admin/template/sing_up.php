...
$sql = "INSERT INTO pages ('username', `password`, 'lastname', 'firstname', 'birthday')
        VALUES (?, ?, ?, ?, ?)
        ";

$stmt = mysqli_prepare($connection, $sql);
mysqli_stmt_bind_param($stmt, "ssssd", $username,$password, $lastname, $firstname, $birthday);
                            ...
                            <form>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 form-group">
                                        <input class="form-control" placeholder="Firstname" value="Firstname" type="text">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <input class="form-control" placeholder="Lastname" value="Lastname" type="text">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <input class="form-control" placeholder="birthday" type="date" value="birthday">
                                </div>
